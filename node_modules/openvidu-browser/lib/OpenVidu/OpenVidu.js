...
var OpenVidu = /** @class */ (function () {
                        ...
                        var getNewVideoDimensions_1 = function () {
                            return new Promise(function (resolve, reject) {
                                if (_this.platform['isIonicIos']) {
                                    ...
                                    var newWidth = ((_this.platform.name.toLowerCase().indexOf('firefox') !== -1) ? firefoxSettings.width : publisher.videoReference.videoWidth);
                                    var newHeight = ((_this.platform.name.toLowerCase().indexOf('firefox') !== -1) ? firefoxSettings.height : publisher.videoReference.videoHeight);
    ...
    OpenVidu.prototype.checkSystemRequirements = function () {
        var browser = this.platform.name;
        var family = this.platform.os.family;
        var userAgent = !!this.platform.ua ? this.platform.ua : navigator.userAgent;
        var isReactNative = this.platform['isReactNative'];
        if (isReactNative) {
            return 1;
        }
    ...
    OpenVidu.prototype.checkScreenSharingCapabilities = function () {
        var _a;
        var browser = this.platform.name;
        var version = ((_a = this.platform) === null || _a === void 0 ? void 0 : _a.version) ? parseFloat(this.platform.version) : -1;
        var family = this.platform.os.family;
    ...
    OpenVidu.prototype.getDevices = function () {
        ...
        return new Promise(function (resolve, reject) {
            navigator.mediaDevices.enumerateDevices().then(function (deviceInfos) {
                ...
                if (_this.platform['isIonicAndroid'] && cordova.plugins && cordova.plugins.EnumerateDevicesPlugin) {
                ...
                else if (_this.platform['isReactNative']) {
                ...
                if (!!myConstraints.videoTrack && !!myConstraints.audioTrack ||
                    ...
                    if (typeof options.videoSource === 'string') {
                        ...
                        if (options.videoSource === 'screen' ||
                            ...
                            (_this.platform.name === 'Electron' && options.videoSource.startsWith('screen:'))) {
                            ...
                            if (navigator.mediaDevices['getDisplayMedia'] && _this.platform.name !== 'Electron') {
            ...
            if (typeof videoSource === 'string') {
                if (!_this.isScreenShare(videoSource)) {
                    ...
                    if (platform['isReactNative']) {
                        myConstraints.constraints.video['facingMode'] = videoSource === '0' ? 'environment' : 'user';
                    }
                    else {
                    ...
                    if (!_this.checkScreenSharingCapabilities()) {
                        var error = new OpenViduError_1.OpenViduError(OpenViduError_1.OpenViduErrorName.SCREEN_SHARING_NOT_SUPPORTED, 'You can only screen share in desktop Chrome, Firefox, Opera, Safari (>=13.0) or Electron. Detected client: ' + _this.platform.name);
                        logger.error(error);
                        reject(error);
                    }
                    else {
                        if (_this.platform.name === 'Electron') {
                            var prefix = "screen:";
                            ...
                            if (!!_this.advancedConfiguration.screenShareChromeExtension && !(_this.platform.name.indexOf('Firefox') !== -1) && !navigator.mediaDevices['getDisplayMedia']) {
                                ...
                                if (navigator.mediaDevices['getDisplayMedia']) {
                                    ...
                                    var firefoxString = _this.platform.name.indexOf('Firefox') !== -1 ? publisherProperties.videoSource : undefined;
    ...
    OpenVidu.prototype.isIPhoneOrIPad = function (userAgent) {
        var isTouchable = typeof document !== 'undefined' && 'ontouchend' in document;
    ...
    OpenVidu.prototype.isIOSWithSafari = function (userAgent) {
        return /\b(\w*Apple\w*)\b/.test(navigator === null || navigator === void 0 ? void 0 : navigator.vendor) && /\b(\w*Safari\w*)\b/.test(userAgent)
