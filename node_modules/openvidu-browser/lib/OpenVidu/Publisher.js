    ...
    Publisher.prototype.initialize = function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var successCallback = function (mediaStream) {
                ...
                if (_this.openvidu.platform.name === 'Safari') {
                ...
                if (_this.stream.isSendVideo()) {
                    if (!_this.stream.isSendScreen()) {
                        if (_this.openvidu.platform['isIonicIos'] || _this.openvidu.platform.name === 'Safari') {
                            ...
                            var width = 500;
                            var height = 400;
                            if ((_this.openvidu.platform.os.family === 'iOS' || _this.openvidu.platform.os.family === 'Android') && (window.innerHeight > window.innerWidth)) {
                        ...
                        _this.videoReference.addEventListener('loadedmetadata', function () {
                            ...
                            _this.screenShareResizeInterval = setInterval(function () {
                                ...
                                var newWidth = (_this.openvidu.platform.name === 'Chrome' || _this.openvidu.platform.name === 'Opera') ? _this.videoReference.videoWidth : firefoxSettings.width;
                                var newHeight = (_this.openvidu.platform.name === 'Chrome' || _this.openvidu.platform.name === 'Opera') ? _this.videoReference.videoHeight : firefoxSettings.height;
                                if (_this.stream.isLocalStreamPublished &&
