    ...
    initialize(): Promise<any> {
        return new Promise((resolve, reject) => {
            ...
            const successCallback = (mediaStream: MediaStream) => {
                ...
                if (this.openvidu.platform.name === 'Safari') {
                ...
                if (this.stream.isSendVideo()) {
                    if (!this.stream.isSendScreen()) {
                        ...
                        if (this.openvidu.platform['isIonicIos'] || this.openvidu.platform.name === 'Safari') {
                            ...
                            if ((this.openvidu.platform.os!!.family === 'iOS' || this.openvidu.platform.os!!.family === 'Android') && (window.innerHeight > window.innerWidth)) {
                        ...
                        this.videoReference.addEventListener('loadedmetadata', () => {
                            ...
                            this.screenShareResizeInterval = setInterval(() => {
                                ...
                                const newWidth = (this.openvidu.platform.name === 'Chrome' || this.openvidu.platform.name === 'Opera') ? this.videoReference.videoWidth : firefoxSettings.width;
                                const newHeight = (this.openvidu.platform.name === 'Chrome' || this.openvidu.platform.name === 'Opera') ? this.videoReference.videoHeight : firefoxSettings.height;
                                if (this.stream.isLocalStreamPublished &&
